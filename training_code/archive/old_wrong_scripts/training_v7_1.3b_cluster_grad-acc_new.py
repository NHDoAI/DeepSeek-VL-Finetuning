...
cluster_flag = True
model_type = "1.3B"
checkpoint_dir = "./1.3b_v7_new_accum_grads_algo/"
...
run_name = "training_v7_1.3b_cluster_grad-acc_new"
batch_size = 4
num_epochs = 30
learning_rate = 1e-4
lora_rank = 4
...
code_artifact.add_file("training_v7_1.3b_cluster_grad-acc_new.py")

# --- Define number of epochs ---

#optimizer = torch.optim.AdamW(model.parameters(), lr=2e-4) # torch optimizer
optimizer = bnb.optim.AdamW(model.parameters(), lr=learning_rate, weight_decay=0.04) # paged optimizer
optimizer.zero_grad() 
