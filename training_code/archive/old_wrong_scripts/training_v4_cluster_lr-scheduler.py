...
run_name = "1.3B-test-run_local_updated_lr-scheduler"
batch_size = 2
num_epochs = 25
learning_rate = 2e-4
lora_rank = 6
...
checkpoint_path = "./1-3B-test-run_local_updated_lr-scheduler"
...
if early_stop_flag:
    ...
    early_stopper = EarlyStopping(final_patience=early_stopping_patience, delta=0, checkpoint_path=checkpoint_path)
...
for epoch in range(num_epochs): # epochs loop
    ...
    if epoch == 0:
        first_epoch_chkpt_path = "./less-lora_first_epoch_chkpoint"
