...
hyperparameters = {
    ...
    "run_name_prefix": "1.3b_final-train/second_version/19-06-2025_2105_pre-trim_b6-s42_short-lidar_focal-loss", # Prefix for run names and checkpoint subdirs
    ...
    "focal_loss_alpha": None, # alpha parameter for focal loss, can be a float or a list of weights
