...
phase_2_start = (1270-50)
phase_3_start = (2540-100)

hyperparameters = {

    "base_checkpoint_dir": "./", # Base directory for checkpoints
    "run_name_prefix": "1.3b_b12/3-epochs/26-06-25_1500_full_b12-s123_dropout-0.05", # Prefix for run names and checkpoint subdirs
    ...
    "early_stopping_active_ranges": [[3800, 20000]], # New: List of [start_step, end_step] ranges for active early stopping. Example: [[0, 2000], [4000, 6000]]
    ...
    "wandb_project_name": "deepseek-vl-ablation_short-prompt_full_short-lidar_2xfocal-loss",
    ...
    "manual_checkpoint_steps":[1100, 1900, 2500, 3200, 3800],
    ...
    "warmup_steps_phases": [50, 50, 50], # Number of warmup steps for WU1, WU2, WU3 respectively
    ...
    with torch.no_grad():
        for batch_idx, batch in enumerate(data_dataloader):
            ...
            loss_fct_none = FocalLoss(
                ...
                alpha=hyperparameters["focal_loss_alpha"], 
                reduction='none', 
                ignore_index=-100
            )
...
wandb.config.update(
    {
        ...
        "focal_loss_alpha": hyperparameters["focal_loss_alpha"],
