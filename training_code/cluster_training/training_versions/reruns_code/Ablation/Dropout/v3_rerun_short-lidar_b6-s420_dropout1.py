...
hyperparameters = {
    ...
    "run_name_prefix": "Ablation/10072025_2300_full_b6-s420_short-lidar_dropout-0.1", # Prefix for run names and checkpoint subdirs
    "eval_every_n_steps": 500, # Will be overridden by phase-specific settings
    "master_seed": 420,
    "num_workers_dataloader": 4,
    "lora_rank": 6,
    "lora_alpha": 12,
    "lora_dropout": 0.1, # Consider changing between 1.3B and 7B models 
    "batch_size": 6,
    "max_epochs": 30,
    "min_lr": 1e-6,
    "max_lr_reductions": 4,
