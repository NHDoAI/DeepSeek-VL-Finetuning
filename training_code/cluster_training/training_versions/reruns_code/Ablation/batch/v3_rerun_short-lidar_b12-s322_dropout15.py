...
hyperparameters = {
    ...
    "run_name_prefix": "Ablation/130725_0600_full_b12-s322_short-lidar_dropout-0.15", # Prefix for run names and checkpoint subdirs
    "eval_every_n_steps": 500, # Will be overridden by phase-specific settings
    "master_seed": 322,
    "num_workers_dataloader": 4,
    "lora_rank": 6,
    "lora_alpha": 12,
    "lora_dropout": 0.15, # Consider changing between 1.3B and 7B models
    "batch_size": 12,
    "max_epochs": 30,
    "min_lr": 1e-6,
    "max_lr_reductions": 4,
    "early_stopping_enabled_globally": True, # New: Master switch for dynamic early stopping
    "early_stopping_active_ranges": [[1250, 20000]], # New: List of [start_step, end_step] ranges for active early stopping. Example: [[0, 2000], [4000, 6000]]
    ...
    "wandb_project_name": "deepseek-vl-rerun_ablation",
