...
hyperparameters = {
    ...
    "run_name_prefix": "1.3b_shortprompt/07072025_0230_pre-trim_b6-s322_no-lidar", # Prefix for run names and checkpoint subdirs
...
train_labels_dir = os.getenv('TRAIN_LABELS_PATH_NOLIDAR')
...
eval_labels_dir_real = os.getenv('EVAL_LABELS_PATH_REAL_NOLIDAR')
print(f"Eval Real Labels Path: {eval_labels_dir_real}")
eval_labels_dir_sim = os.getenv('EVAL_LABELS_PATH_SIM_NOLIDAR')
...
dataset_artifact = wandb.Artifact(name="train_data_artifact_nolidar", type="dataset")
dataset_artifact.add_dir("./train/images")
dataset_artifact.add_dir("./train/labels_nolidar")
dataset_artifact.add_dir("./eval/real/images")
dataset_artifact.add_dir("./eval/real/labels_nolidar")
dataset_artifact.add_dir("./eval/simulation/images")
dataset_artifact.add_dir("./eval/simulation/labels_nolidar")
