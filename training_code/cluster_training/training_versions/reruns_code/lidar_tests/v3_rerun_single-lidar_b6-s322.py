...
hyperparameters = {
    ...
    "run_name_prefix": "1.3b_shortprompt/07072025_0230_pre-trim_b6-s322_single-lidar", # Prefix for run names and checkpoint subdirs
...
train_labels_dir = os.getenv('TRAIN_LABELS_PATH_SINGLELIDAR')
...
eval_labels_dir_real = os.getenv('EVAL_LABELS_PATH_REAL_SINGLELIDAR')
...
dataset_artifact = wandb.Artifact(name="train_data_artifact_singlelidar", type="dataset")
