...
hyperparameters = {
    ...
    "run_name_prefix": "1.3b_shortprompt/focalloss-test/080725_0400_pre-trim_b6-s322_short-lidar_focal-loss_custom-alpha", # Prefix for run names and checkpoint subdirs
