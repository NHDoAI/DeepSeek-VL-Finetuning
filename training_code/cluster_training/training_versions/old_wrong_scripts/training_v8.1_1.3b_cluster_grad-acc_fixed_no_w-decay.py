...
cluster_flag = True
model_type = "1.3B"
checkpoint_dir = "./1.3b_v8.1_grad-acc_fixed_no_w-decay/"
script_name = "training_v8.1_1.3b_cluster_grad-acc_fixed_no_w-decay.py"
run_name = "training_1.3b_v8.1_grad-acc_fixed_no_w-decay"
...
optimizer = bnb.optim.AdamW(model.parameters(), lr=learning_rate, weight_decay=0.0) # paged optimizer
optimizer.zero_grad() 
...
for epoch in range(num_epochs):
    ...
    for batch_idx, batch in enumerate(train_dataloader):
        ...
        outputs = model.language_model(
            ...
            attention_mask=batch['attention_mask'],
            labels= batch["labels"],
            num_items_in_batch=current_batch_size
        )
        # if cluster_flag:
