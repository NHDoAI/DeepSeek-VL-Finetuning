...
hyperparameters = {
    ...
    "run_name_prefix": "1.3b_final-train/first_version/12-06-2025_seed42", # Prefix for run names and checkpoint subdirs
    ...
    "early_stopping_active_ranges": [[1650, 20000]], # New: List of [start_step, end_step] ranges for active early stopping. Example: [[0, 2000], [4000, 6000]]
