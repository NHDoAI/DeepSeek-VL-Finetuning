...
cluster_flag = True
model_type = "1.3B"
checkpoint_dir = "./1.3b_v8_grad-acc_fixed-reduction_default-weight-decay/"
script_name = "training_v8_1.3b_cluster_grad-acc_fixed-reduction.py"
...
run_name = "training_1.3b_v8_grad-acc_fixed-reduction_default-weight-decay"
batch_size = 4
num_epochs = 30
learning_rate = 2e-4
lora_rank = 4
