...
hyperparameters = {
    ...
    "run_name_prefix": "1.3b_shortprompt/08072025_0230_pre-trim_b6-s42_short-lidar_2epochs", # Prefix for run names and checkpoint subdirs
    ...
    "manual_checkpoint_steps":[2299, 3800, 5074], # steps at which to manually save checkpoints
