...
hyperparameters = {
    ...
    "run_name_prefix": "1.3b/Option-B_s42", # Prefix for run names and checkpoint subdirs
...
def evaluate_model(model, data_dataloader):
    ...
    with torch.no_grad():
        for batch_idx, batch in enumerate(data_dataloader):
            ...
            loss = weighted_loss_calculation(logits, labels, sentinel_ids, hyperparameters["keyword_weight"], hyperparameters["background_weight"], slot_table)
            ...
            correct_count, total_count = compute_sentinel_accuracy(logits, labels, sentinel_ids, slot_table)
