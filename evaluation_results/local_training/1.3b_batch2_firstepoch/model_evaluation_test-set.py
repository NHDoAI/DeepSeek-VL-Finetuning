...
""" Generate response from model on sets. Used on test or eval set. It reads image path from json result files, generate answer from that image(prompt used defined in the script, not taken from result files) and then save answer in the same format as result files in a folder. A json file for each image."""
...
def main():
    ...
    model_path = "/home/ubuntu/DeepSeek-VL-Finetuning/training_code/local_training/Model_merge_1.3b/merged_model/"
