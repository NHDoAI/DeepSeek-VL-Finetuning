...
def extract_categories_from_results(results_dir, output_dir, overall_timestamp):
    ...
    for data_type_info in data_types_to_process:
        ...
        if results_current_type:
            output_csv_filename = f'{script_base_name}{type_suffix}_{overall_timestamp}.csv'
...
def analyze_and_generate_report(model_results_csv_paths_list, overall_timestamp,
    ...
    for model_results_csv in model_results_csv_paths_list:
        try:
            ...
            output_filepath = os.path.join(type_specific_comparison_output_dir, output_filename)
...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Short-prompt-v2-short-lidar_b6_s322_fixed-userprompt/manual_eval_chkpoint_11/adapter/"
            merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Short-prompt-v2-short-lidar_b6_s322_fixed-userprompt/manual_eval_chkpoint_11/merged_model/"
