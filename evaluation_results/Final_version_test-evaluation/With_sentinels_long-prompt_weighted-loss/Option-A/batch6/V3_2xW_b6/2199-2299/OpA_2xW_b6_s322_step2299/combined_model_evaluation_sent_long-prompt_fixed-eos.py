...
def run_inference(model_path, base_labels_dir, mode = "fp16"):
    ...
    for sub_dir_name in sub_dirs_to_process:
        ...
        for i, label_file_path in enumerate(json_label_files):
            ...
            answer = tokenizer.decode(generated_tokens.cpu().tolist(), skip_special_tokens=False)
...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/OpA_2xW_b6_s322/manual_eval_chkpoint_22/adapter/"
            merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/OpA_2xW_b6_s322/manual_eval_chkpoint_22/merged_model/"
