...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            if mode == 'simulation':
                adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Real-training_b6-s23_from-sim-b6-s23-full-epoch/first_epoch_chkpoint/adapter/"
                merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Real-training_b6-s23_from-sim-b6-s23-full-epoch/first_epoch_chkpoint/merged_model_sim/"
            else: # mode == 'real'
                # PLEASE UPDATE these paths for your 'real' model's checkpoints and desired output directory
                adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Real-training_b6-s23_from-sim-b6-s23-full-epoch/first_epoch_chkpoint/adapter/"
                merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Real-training_b6-s23_from-sim-b6-s23-full-epoch/first_epoch_chkpoint/merged_model_real/"
