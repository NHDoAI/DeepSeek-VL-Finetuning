...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            if mode == 'simulation':
                adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Sim-training_b6-s42_new-prompt-single-lidar/best_chkpoint/adapter/"
                merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Sim-training_b6-s42_new-prompt-single-lidar/best_chkpoint/merged_model_sim/"
            else: # mode == 'real'
