...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            if mode == 'simulation':
                adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Sim-training_b6-s322_new-prompt-single-lidar/manual_eval_chkpoint_12/adapter/"
                merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Sim-training_b6-s322_new-prompt-single-lidar/manual_eval_chkpoint_12/merged_model_sim/"
            else: # mode == 'real'
                # PLEASE UPDATE these paths for your 'real' model's checkpoints and desired output directory
                adapter_checkpoint = "/path/to/your/REAL_ADAPTER_CHECKPOINT"
                merged_model_dir = "/path/to/your/REAL_MERGED_MODEL_DIR"
