...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/full_b6-s23_shortprompt_short-lidar_focal-loss_custom-alpha/manual_eval_chkpoint_30/adapter/"
            merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/full_b6-s23_shortprompt_short-lidar_focal-loss_custom-alpha/manual_eval_chkpoint_30/merged_model/"
            ...
            if extract_cat_flag:
                ...
                model_results_csv = ["./extraction_results/real/full_b6-s23_shortfixedprompt_short-lidar_CE-loss_best_real.csv", "./extraction_results/simulation/full_b6-s23_shortfixedprompt_short-lidar_CE-loss_best_sim.csv"]
