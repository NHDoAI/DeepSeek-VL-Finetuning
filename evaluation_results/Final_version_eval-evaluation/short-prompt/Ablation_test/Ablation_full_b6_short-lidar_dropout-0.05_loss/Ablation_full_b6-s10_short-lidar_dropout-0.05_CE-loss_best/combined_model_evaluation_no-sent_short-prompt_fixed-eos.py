...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Ablation_full_b6-s10_short-lidar_dropout-0.05_CE-loss/best_chkpoint/adapter/"
            merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Ablation_full_b6-s10_short-lidar_dropout-0.05_CE-loss/best_chkpoint/merged_model/"
