...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Ablation_full_b12-s420_short-lidar_dropout-0.15_CE-loss/manual_eval_chkpoint_10/adapter/"
            merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_stage/new_cluster_training_runs_final-ver_models/Ablation_full_b12-s420_short-lidar_dropout-0.15_CE-loss/manual_eval_chkpoint_10/merged_model/"
            ...
            if extract_cat_flag:
                ...
                model_results_csv = ["./extraction_results/real/full_b12-s23_shortfixedprompt_short-lidar_CE-loss_best_real.csv", "./extraction_results/simulation/full_b12-s23_shortfixedprompt_short-lidar_CE-loss_best_sim.csv"]
