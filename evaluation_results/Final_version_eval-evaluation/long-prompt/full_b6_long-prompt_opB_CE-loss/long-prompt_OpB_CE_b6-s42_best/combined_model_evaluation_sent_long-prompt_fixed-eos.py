...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "../active_chkpoint/long-prompt_OpB_CE_b6-s42/best_chkpoint/adapter/"
            merged_model_dir = "../active_chkpoint/long-prompt_OpB_CE_b6-s42/best_chkpoint/merged_model/"
