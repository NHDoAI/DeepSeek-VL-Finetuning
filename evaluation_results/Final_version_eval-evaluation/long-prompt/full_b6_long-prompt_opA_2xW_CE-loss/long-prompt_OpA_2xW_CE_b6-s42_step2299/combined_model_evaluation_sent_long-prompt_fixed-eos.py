...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "../active_chkpoint/long-prompt_OpA_2xW_CE_b6-s42/manual_eval_chkpoint_22/adapter/"
            merged_model_dir = "../active_chkpoint/long-prompt_OpA_2xW_CE_b6-s42/manual_eval_chkpoint_22/merged_model/"
