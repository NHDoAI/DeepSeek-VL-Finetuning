...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "../active_chkpoint/long-prompt_no-sent_CE_b6-s42/first_epoch_chkpoint/adapter/"
            merged_model_dir = "../active_chkpoint/long-prompt_no-sent_CE_b6-s42/first_epoch_chkpoint/merged_model/"
            ...
            if extract_cat_flag:
                ...
                model_results_csv = ["./extraction_results/real/long-prompt_no-sent_CE_b6-s42_full-epoch_real.csv", "./extraction_results/simulation/long-prompt_no-sent_CE_b6-s42_full-epoch_sim.csv"]
                overall_timestamp = "20250705_200839"
