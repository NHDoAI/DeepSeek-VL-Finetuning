...
def main():
    ...
    with open(log_file_name, 'w') as log_file:
        ...
        try:
            ...
            adapter_checkpoint = "../active_chkpoint/long-prompt_no-sent_CE_b6-s322/manual_eval_chkpoint_30/adapter/"
            merged_model_dir = "../active_chkpoint/long-prompt_no-sent_CE_b6-s322/manual_eval_chkpoint_30/merged_model/"
            test_labels_dir = "./eval/"
            extraction_dir = "./extraction_results/"
            
            merge_model_flag = False
            quantize_model_flag = False
            run_inference_flag = False
            extract_cat_flag = False
            ...
            if extract_cat_flag:
                ...
                model_results_csv = ["./extraction_results/real/long-prompt_no-sent_CE_b6-s322_step2299_real.csv", "./extraction_results/simulation/long-prompt_no-sent_CE_b6-s322_step2299_sim.csv"]
                overall_timestamp = "20250705_211450"
