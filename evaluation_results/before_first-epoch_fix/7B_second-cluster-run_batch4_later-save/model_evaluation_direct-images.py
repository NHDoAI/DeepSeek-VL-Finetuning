...
"""get the model answers directly from images set. Uses the image path from json files and generate answer for that image, then save the results to a folder."""
...
def main():
    ...
    model_path = "/home/ubuntu/DeepSeek-VL-Finetuning/training_code/cluster_training/saved_model_first-run_batch_4_test/models/merged_model_later_save/"
