...
def main():
    ...
    adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_code/cluster_training/after_first-epoch_fix_models/1.3B_lr-scheduler_no-train-shuffle_smallset/first_epoch_chkpoint/adapter/"
    merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_code/cluster_training/after_first-epoch_fix_models/1.3B_lr-scheduler_no-train-shuffle_smallset/first_epoch_chkpoint/merged_model_first_epoch"
    ...
    if run_inference_flag:
        ...
        inference_results_dir = "./eval_output/inference_20250430_213705"
