...
def compare_results_with_ground_truth(model_results_csv, ground_truth_csv, output_dir):
    ...
    category_orders = {
        'lane': ["right lane", "left lane"],
        'obstacle': ["far away", "near", "very close", "not on the same lane"],
        'decision': ["straight forward", "slow cruise", "change lane left", "change lane right"],
        'final_decision': ["straight forward", "slow cruise", "change lane left", "change lane right"]
    }
...
def main():
    ...
    adapter_checkpoint = "/home/ubuntu/DeepSeek-VL-Finetuning/training_code/cluster_training/after_first-epoch_fix_models/1.3b_lr-scheduler_accumulated-grads/first_epoch_chkpoint/adapter/"
    merged_model_dir = "/home/ubuntu/DeepSeek-VL-Finetuning/training_code/cluster_training/after_first-epoch_fix_models/1.3b_lr-scheduler_accumulated-grads/first_epoch_chkpoint/merged_model_first_epoch"
